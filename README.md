...
Pawn development tools for VS Code and Zed, built for the open.mp / SA-MP Pawn ecosystem.
...
Originally created by [Indian Ocean Roleplayเนยเธ (samarmeena)](https://github.com/samarmeena)
...
![](https://github.com/JohnPeriaX/svgzed-vscode-pawn/blob/master/assets/snippet.gif)
...
![](https://github.com/JohnPeriaX/svgzed-vscode-pawn/blob/master/assets/pawnignore.gif)

# Installation

Search for "Pawn Forge" in the VS Code Extensions section and install it.
Alternatively, you can check out the source code or view the marketplace page:

- [GitHub Page](https://github.com/JohnPeriaX/svgzed-vscode-pawn)
- [Marketplace Page](https://marketplace.visualstudio.com/items?itemName=pawnforge.pawn-development)
